...
// Config holds the configuration for the MySQL proxy
type Config struct {
	// ListenAddr is the address to listen for MySQL connections
...
func DefaultConfig() *Config {
	return &Config{
		...
		ListenAddr:    ":3306",
		LabelSelector: "managedBy=kubestrator,type=mysql",
		UseProxyProto: true,
	}
}
